(function(t) {
    function e(e) {
        for (var i, s, r = e[0], l = e[1], c = e[2], _ = 0, u = []; _ < r.length; _++) s = r[_], Object.prototype.hasOwnProperty.call(n, s) && n[s] && u.push(n[s][0]), n[s] = 0;
    ...
    4678: function(t, e, a) {
        ...
        }, n.resolve = o, t.exports = n, n.id = "4678"
    },
    "50d7": function(t, e, a) {
        "use strict";
        a("af70")
    ...
    "56d7": function(t, e, a) {
        ...
        var i = a("2b0e"),
            n = function() {
                ...
                }, [a("v-app", [a("v-content", [a("router-view")], 1), a("BottomNavigation")], 1)], 1)
            },
            o = [],
            s = function() {
                var t = this,
                ...
                }, [a("span", [t._v(t._s(t.$t("main.home")))]), a("v-icon", [t._v("sports_esports")])], 1), t.$store.state.is_show_win_tab ? a("v-btn", {
                    attrs: {
                        color: "primary",
                        flat: "",
                        value: "win",
                ...
                }, [a("span", [t._v(t._s(t.$t("win.period")))]), a("v-icon", [t._v("military_tech")])], 1) : t._e(), a("v-btn", {
                    attrs: {
                        color: "primary",
                        flat: "",
                        value: "mine",
                ...
                }, [a("span", [t._v(t._s(t.$t("main.mine")))]), a("v-icon", [t._v("portrait")])], 1)], 1)], 1)], 1) : t._e()
            },
            r = [],
            l = {
                data: function() {
        ...
        var T = a("ce5b"),
            ...
            I = function() {
                ...
                return a("div", [a("v-img", {
                ...
                }, [a("span", [t._v(t._s(t.$t("shop.shop_now")))])]), a("div", {
                    staticStyle: {
                        "text-align": "center",
                    ...
                    return a("v-flex", t._b({
                        key: e.id
                    }, "v-flex", (i = {}, i["xs6"] = !0, i), !1), [a("router-link", {
                        staticStyle: {
                ...
                }, [t._v(t._s(t.$t("main.notice")))]), a("v-card-text", [t._v(t._s(t.notice_content))]), a("v-card-actions", [a("v-spacer"), a("v-btn", {
                    attrs: {
            ...
            M = a("71d9"),
            G = a("2a7f"),
            H = Object(d["a"])(L, q, E, !1, null, null, null);
        H.exports;
        ...
        function X(t, e) {
            e.response && 401 == e.response.status && (t.$store.state.accessToken = null, localStorage.removeItem("coem.token"), t.$router.push("/login"))
        }
        ...
        function Z(t, e) {
            ...
            return a["Accept-Language"] = t.$store.state.locale, a
        }
        u()(H, {
            VAvatar: A["a"],
            VBtn: m["a"],
            ...
            VListTileAction: W["a"],
            VListTileAvatar: O["a"],
            VListTileContent: F["b"],
            VListTileTitle: F["d"],
            VNavigationDrawer: N["a"],
            VSpacer: U["a"],
            VToolbar: M["a"],
            VToolbarTitle: G["a"]
        });
        var tt = {
            ...
            et = {
                methods: {
                    download_app: function() {
                        ...
                        tt.get(this, "/shop/home_top?t=" + e, !1, (function(e, a) {
                    ...
                    loadHomeTop: function() {
                        ...
                        tt.get(this, "/shop/home_top?t=" + e, !1, (function(e, a) {
                            ...
                            console.log("home_top load fail"), console.log(e.toString()), "Error: Network Error" == e.toString() && (t.notice_content = t.$t("msg.maintenance"), t.notice_dialog = !0)
                        }))
                    },
                    loadProducts: function() {
                        var t = this,
                            ...
                            i = e + "/shop/products?t=" + a,
                            n = this.$store.state.imgUrl;
                        this.$ajax.get(i).then((function(e) {
                            var a = e.data.queryset;
                            for (var i in a) {
                                var o = a[i];
                                o.main_image = n + o.main_image, o.price = t.$t("main.currency_symbol") + " " + o.price
                            }
                            t.cards = a
                        })).catch((function(t) {
                            console.log(t)
                ...
                created: function() {
                    this.$store.state.show_bottom_menu = !0, this.loadHomeTop(), this.loadProducts();
                    var t = this.$route.query.in_app;
                    null != t ? (console.log("query_in_app is not null"), localStorage.setItem("coem.query_in_app", t)) : (t = localStorage.getItem("coem.query_in_app"), null == t && (t = "0", localStorage.setItem("coem.query_in_app", t))), this.in_app = "1" == t
                },
                data: function() {
                    return {
                        in_app: !0,
            ...
            ct = a("0e8f"),
            dt = a("adda"),
            _t = Object(d["a"])(at, I, D, !1, null, null, null);
        _t.exports;
        u()(_t, {
            VBtn: m["a"],
            VCard: v["a"],
        ...
        var ut = function() {
                ...
                return a("div", [a("v-toolbar", {
                ...
                }, [a("v-toolbar-side-icon", [a("v-img", {
                    attrs: {
                        src: t.$store.state.imgUrl + "/logo/icon.png"
                    }
                })], 1), a("v-toolbar-title", {
                    staticStyle: {
                        color: "#616161"
                    }
                }, [t._v(t._s(t.$t("shop.open_with_an_app")))]), a("v-spacer"), a("v-btn", {
                    attrs: {
                        icon: ""
                    },
                    on: {
                ...
                }, [a("v-toolbar-title", [t._v("Amusebox")]), a("v-spacer")], 1), a("v-card", [a("v-container", {
                    attrs: {
                        fluid: "",
                        "grid-list-lg": ""
                    }
                    ...
                    return a("v-flex", {
                        ...
                        staticClass: "white--text",
                        attrs: {
                            color: t.bg_colors[i % t.bg_colors.length]
                        }
                    }, [a("v-layout", [a("v-flex", {
                        attrs: {
                            xs5: ""
                        ...
                        staticClass: "pa-3"
                    }, [t._v("\n                    View this game\n                    "), a("v-spacer"), a("v-list-tile-action", [a("v-btn", {
                        attrs: {
                            small: "",
                            color: "primary",
                            dark: ""
            ...
            mt = (a("7f7f"), {
                ...
                methods: {
                    download_app: function() {
                        ...
                        tt.get(this, "/user/get_app_version?t=" + t, !1, (function(t, e) {
                            var a = e.data.code;
                            if (200 == a) {
                                var i = e.data.landing_page;
                                location.href = i
                            }
                        }))
                    },
                    start_game: function(t) {
                        var e = t.href;
                        window.open(e)
                    },
                    load_games: function() {
                        var t = this,
                            e = this.$store.state.imgUrl,
                            a = this.$store.state.svrUrl,
                            i = Date.parse(new Date),
                            n = a + "/shop/games?t=" + i;
                        this.$ajax.get(n).then((function(a) {
                            var i = a.data.queryset;
                            for (var n in i) {
                                var o = i[n];
                                o.avatar = e + o.main_image, o.bg = e + o.image2, o.title = o.name, o.subtitle = o.description
                            }
                            t.items = i
                        })).catch((function(t) {
                            console.log(t)
                ...
                data: function() {
                    return {
                        items: [],
                        bg_colors: ["cyan darken-2", "purple", "light-blue darken-1", "green darken-3", "amber accent-3", "blue-grey darken-1"]
                    }
                }
            }),
            vt = mt,
            ht = a("706c"),
            gt = Object(d["a"])(vt, ut, pt, !1, null, null, null),
            ft = gt.exports;
        u()(gt, {
            VBtn: m["a"],
            VCard: v["a"],
        ...
        var yt = function() {
            ...
            xt = {
                methods: {
                    loadProducts: function(t) {
                        var e = this,
                            a = this.$store.state.svrUrl,
                            i = Date.parse(new Date),
                            n = a + "/shop/products?t=" + i;
                        "" != t && (n += "&keyword=" + t), this.$ajax.get(n).then((function(t) {
                            var i = t.data.queryset;
                            for (var n in i) {
                                var o = i[n];
                                o.main_image = a + o.main_image, o.price = e.$t("main.currency_symbol") + " " + o.price
                            }
                            e.cards = i
                        })).catch((function(t) {
                            console.log(t)
                ...
                created: function() {
                    this.$store.state.show_bottom_menu = !0, this.loadProducts("")
                },
                data: function() {
                    return {
                        tab: null,
            ...
            wt = xt,
            kt = (a("2e28"), a("2677")),
            St = Object(d["a"])(wt, yt, bt, !1, null, "7c3dbc9f", null),
            $t = St.exports;
        u()(St, {
            VCard: v["a"],
            VCardActions: it["a"],
        ...
        var Ct = function() {
            ...
            Tt = (a("28a5"), {
                methods: {
                    ...
                    loadItem: function() {
                        ...
                        var e = this,
                            a = this.$store.state.svrUrl,
                            i = this.$store.state.imgUrl,
                            n = Date.parse(new Date),
                            o = a + "/shop/product?id=" + t + "&t=" + n;
                        this.$ajax.get(o).then((function(t) {
                            var a = t.data.entry;
                            a.price = e.$t("main.currency_symbol") + " " + a.price;
                            var n = [];
                            n.push(i + a.main_image), null != a.image2 && n.push(i + a.image2), null != a.image3 && n.push(i + a.image3), a.images = n;
                            var o = a.spec.split(","),
                                s = [];
                            for (var r in o) {
                                var l = o[r],
                            ...
                            a.desserts = s, e.item = a, a.stock > 0 ? e.buy_disabled = !1 : e.buy_button_text = e.$t("shop.sold_out")
                        })).catch((function(t) {
                            console.log(t)
                        }))
                    }
            ...
            Pt = Tt,
            jt = a("8fea"),
            It = Object(d["a"])(Pt, Ct, Vt, !1, null, null, null),
            Dt = It.exports;
        u()(It, {
            VBtn: m["a"],
            VCardActions: it["a"],
        ...
        var qt = function() {
                ...
                return a("div", {
                ...
                }, [t._v("get_app")])], 1)], 1), a("v-card", [a("v-container", {
                    staticStyle: {
                        padding: "0"
                    }
                }, [a("v-alert", {
                    ...
                    attrs: {
                        value: t.notice_display,
                        type: "info"
                    }
                }, [t._v("\n        " + t._s(t.notice_content) + "\n      ")]), a("v-layout", {
                    attrs: {
                        row: "",
                        wrap: ""
                    }
                    ...
                    on: {
                        click: function(e) {
                            return t.show_add_user_guess_dialog("G", -1)
                        }
                    }
                    ...
                    on: {
                        click: function(e) {
                            return t.show_add_user_guess_dialog("V", -1)
                        }
                    }
                    ...
                    on: {
                        click: function(e) {
                            return t.show_add_user_guess_dialog("R", -1)
                        }
                    }
                    ...
                    scopedSlots: t._u([{
                        ...
                        fn: function(e) {
                            ...
                            }, [t._v(t._s(e.item.period))]), a("td", {
                                staticClass: "text-xs-center",
                                staticStyle: {
                                    padding: "0 8px"
                                }
                            }, [t._v(t._s(e.item.price))]), e.item.is_red ? a("td", {
                                staticClass: "text-xs-center",
                                staticStyle: {
                                    color: "#FF1744",
                                    padding: "0 8px"
                                }
                            }, [t._v(t._s(e.item.last_num) + "\n            ")]) : t._e(), e.item.is_green ? a("td", {
                                staticClass: "text-xs-center",
                                staticStyle: {
                                    color: "#00E676",
                                    padding: "0"
                            ...
                            }, [a("v-spacer"), e.item.is_red ? a("div", {
                                staticClass: "point",
                                staticStyle: {
                                    "background-color": "#FF1744"
                                }
                            }) : t._e(), e.item.is_green ? a("div", {
                                staticClass: "point",
                                staticStyle: {
                                    "background-color": "#00E676"
                                }
                            }) : t._e(), t._v("\n                 \n                "), e.item.is_violet ? a("div", {
                                staticClass: "point",
                                staticStyle: {
                        ...
                        fn: function(e) {
                            return [a("v-expansion-panel", [a("v-expansion-panel-content", {
                                scopedSlots: t._u([{
                                    key: "header",
                                    fn: function() {
                                        return [a("div", [a("span", [t._v(t._s(e.item.period))]), t._v("  \n                    "), "F" == e.item.status ? a("span", {
                                            staticStyle: {
                                                color: "red"
                                            }
                                        }, [t._v(t._s(t.$t("win.fail")) + "  ")]) : t._e(), "F" == e.item.status ? a("span", {
                                            staticStyle: {
                                                color: "red"
                                            }
                                        }, [t._v(t._s(e.item.amount) + "  ")]) : t._e(), "S" == e.item.status ? a("span", {
                                            staticStyle: {
                                                color: "green"
                                            }
                                        }, [t._v(t._s(t.$t("win.success")) + "  ")]) : t._e(), "S" == e.item.status ? a("span", {
                                            staticStyle: {
                                                color: "green"
                                            }
                                        }, [t._v(t._s(e.item.amount) + "  ")]) : t._e(), "W" == e.item.status ? a("span", {
                                            staticStyle: {
                                                color: "orange"
                                            }
                            ...
                            }, [t._v("\n                        " + t._s(e.item.fee) + "\n                      ")])], 1), null != e.item.open_price ? a("v-layout", {
                                staticStyle: {
                                    "margin-top": "8px"
                                }
                            }, [a("v-flex", {
                            ...
                            }, [t._v("\n                        " + t._s(e.item.open_price) + "\n                      ")])], 1) : t._e(), null != e.item.result ? a("v-layout", {
                                staticStyle: {
                                    "margin-top": "8px"
                                }
                            }, [a("v-flex", {
                            ...
                            }, [t._v(t._s(e.item.result) + "  ")]), ["1", "3", "5", "7", "9"].indexOf(e.item.result) >= 0 ? a("span", {
                                staticStyle: {
                                    color: "#00E676",
                                    "font-weight": "bold"
                                }
                            }, [t._v(t._s(t.$t("win.green")) + " ")]) : t._e(), ["2", "4", "6", "8", "0"].indexOf(e.item.result) >= 0 ? a("span", {
                                staticStyle: {
                                    color: "#FF1744",
                                    "font-weight": "bold"
                                }
                            }, [t._v(t._s(t.$t("win.red")) + " ")]) : t._e(), ["0", "5"].indexOf(e.item.result) >= 0 ? a("span", {
                                staticStyle: {
                                    color: "#651FFF",
                                    "font-weight": "bold"
                                }
                            ...
                            }, ["G" == e.item.type ? a("span", {
                                staticStyle: {
                                    color: "#00E676",
                                    "font-weight": "bold"
                                }
                            }, [t._v(t._s(t.$t("win.green")))]) : t._e(), "R" == e.item.type ? a("span", {
                                staticStyle: {
                                    color: "#FF1744",
                                    "font-weight": "bold"
                                }
                            }, [t._v(t._s(t.$t("win.red")))]) : t._e(), "V" == e.item.type ? a("span", {
                                staticStyle: {
                                    color: "#651FFF",
                                    "font-weight": "bold"
                                }
                            }, [t._v(t._s(t.$t("win.violet")))]) : t._e(), "N" == e.item.type ? a("span", {
                                staticStyle: {
                                    color: "#00B0FF",
                                    "font-weight": "bold"
                                }
                            ...
                            }, ["S" == e.item.status ? a("span", {
                                staticStyle: {
                                    color: "green"
                                }
                            }, [t._v(t._s(t.$t("win.success")))]) : t._e(), "F" == e.item.status ? a("span", {
                                staticStyle: {
                                    color: "red"
                                }
                            }, [t._v(t._s(t.$t("win.fail")))]) : t._e(), "W" == e.item.status ? a("span", {
                                staticStyle: {
                                    color: "orange"
                                }
                            }, [t._v(t._s(t.$t("win.wait")))]) : t._e()])], 1), null != e.item.amount ? a("v-layout", {
                                staticStyle: {
                                    "margin-top": "8px"
                                }
                            }, [a("v-flex", {
                            ...
                            }, [t._v(t._s(e.item.amount))]) : t._e(), "F" == e.item.status ? a("span", {
                                staticStyle: {
                                    color: "red"
                                }
                            }, [t._v(t._s(e.item.amount))]) : t._e()])], 1) : t._e(), a("v-layout", {
                                staticStyle: {
                                    "margin-top": "8px"
                                }
                            }, [a("v-flex", {
                            ...
                            }, [t._v("\n                        " + t._s(t._f("date_format")(e.item.create_time)) + "\n                      ")])], 1)], 1)], 1)], 1)], 1)]
                        }
                    }])
                })], 1)], 1)], 1), a("v-layout", {
                    attrs: {
                ...
                }, [a("v-card", ["G" == t.guess.guess_type ? a("v-card-title", {
                    staticClass: "headline lighten-2",
                    staticStyle: {
                        color: "white",
                        "background-color": "#00E676"
                    }
                }, [t._v(t._s(t.$t("win.join_green")) + "\n          ")]) : t._e(), "V" == t.guess.guess_type ? a("v-card-title", {
                    staticClass: "headline lighten-2",
                    staticStyle: {
                        color: "white",
                        "background-color": "#651FFF"
                    }
                }, [t._v(t._s(t.$t("win.join_violet")) + "\n          ")]) : t._e(), "R" == t.guess.guess_type ? a("v-card-title", {
                    staticClass: "headline lighten-2",
                    staticStyle: {
                        color: "white",
                        "background-color": "#FF1744"
            ...
            Et = [],
            Yt = (a("3b2b"), a("a481"), a("2f62")),
            Lt = a("bd86"),
            At = Object(Lt["a"])({}, "changeTabValue", (function(t, e) {
                t.tabValue = e
            })),
            zt = Object(Lt["a"])({}, "changeTabValue", (function(t, e) {
                var a = t.commit;
                a("changeTabValue", e)
            }));
        i["default"].use(Yt["a"]);
        var Bt = {
                shopName: "Rxce",
                appPrefix: "rxce_",
                svrUrl: "https://rxce.in",
                appUrl: "https://rxce.in",
                imgUrl: "https://img.rxce.in",
                locale: "in",
                show_bottom_menu: !0,
                tabValue: "Home",
        ...
        function Wt(t, e) {
            ...
            for (var i in a)
                if (new RegExp("(".concat(i, ")")).test(e)) {
                    var n = a[i] + "";
                    e = e.replace(RegExp.$1, 1 === RegExp.$1.length ? n : Ot(n))
                }
            return e
        }
        ...
        var Ft = {
                filters: {
                    date_format: function(t) {
                        var e = new Date(t);
                        return Wt(e, "yyyy-MM-dd hh:mm")
                    }
                },
                methods: {
                    reload: function() {
                        this.loading_dialog = !0, this.load_next_period_info(), this.pagination.page = 1, this.load_guesses(), this.my_pagination.page = 1, this.load_my_guesses()
                    },
                    ...
                    change_contract_number: function(t) {
                        ...
                        e = "" == e ? 0 : parseInt(e), t ? e += 1 : (e -= 1, e < 1 && (e = 1)), this.contract_number = e
                    },
                    my_record_click: function() {
                        location.href = "/#/myGuessRecord?category_value=" + this.category_values[this.selected_category_index]
                    },
                    record_click: function() {
                        location.href = "/#/guessRecord?category_value=" + this.category_values[this.selected_category_index]
                    },
                    goRecharge: function() {
                    ...
                    show_add_user_guess_dialog: function(t, e) {
                        this.guess.guess_type = t, this.guess.num = e, this.contract_money_index = 0, this.contract_number = 1, this.add_user_guess_dialog = !0
                    },
                    add_user_guess: function() {
                        if (this.agree_presale_rule) {
                            this.add_user_guess_dialog = !1, this.loading_dialog = !0;
                            ...
                            tt.post(this, "/win/add_user_guess", e, !0, (function(t, e) {
                                t.loading_dialog = !1, 200 == e.data.code ? (t.result_title = t.$t("main.completed"), t.result_text = t.$t("msg.contract_completed"), t.result_dialog = !0, t.load_next_period_info(), t.load_my_guesses()) : (t.result_title = t.$t("main.fail"), t.result_text = e.data.msg, t.result_dialog = !0)
                            }))
                        }
                    },
                    category_click: function(t) {
                        this.selected_category_index = t, this.$store.state.selected_category_index = t, localStorage.setItem("coem.selected_category_index", t), this.pagination.page = 1, this.load_guesses(), this.my_pagination.page = 1, this.load_my_guesses()
                    },
                    continue_click: function() {
                        this.load_next_period_info(), this.pagination.page = 1, this.load_guesses(), this.my_pagination.page = 1, this.load_my_guesses(), this.count_down_num_show = !0, this.continue_button_show = !1, this.continue_button_disabled = !0;
                    ...
                    start_count_down: function(t) {
                        if (this.$store.state.count_started_tag == t) {
                            ...
                            var i = a / 60,
                                ...
                                o = n / 10,
                                s = n % 10;
                            this.min_ten = "0", this.min_bit = Math.floor(i), this.sec_ten = Math.floor(o), this.sec_bit = Math.floor(s);
                            var r = this;
                            setTimeout((function() {
                                r.start_count_down(t)
                            }), 1e3), 180 == a && (this.count_down_num_show = !1, this.continue_button_show = !0, setTimeout((function() {
                    ...
                    load_next_period_info: function() {
                        ...
                        this.$ajax.get(n, {
                            ...
                            if (200 == t.data.code) {
                                e.balance = t.data.balance.toFixed(2), e.next_period = t.data.next_period;
                                var a = t.data.notice_content;
                                null != a && a.length > 0 ? (e.notice_content = a, e.notice_display = !0, localStorage.setItem("coem.notice", a)) : (e.notice_display = !1, localStorage.removeItem("coem.notice"))
                            }
                        })).catch((function(t) {
                            console.log(t), t.response && 401 == t.response.status && (localStorage.removeItem("coem.token"), e.$store.state.accessToken = null, location.href = "/#/login")
                        }))
                    },
                    prepay: function(t) {
                        location.href = "/#/item?id=" + t
                    },
                    auto_reload_listener: function() {
                        if ("hidden" === document.visibilityState && console.log("page hidden"), "visible" === document.visibilityState) {
                            console.log("page visible");
                            var t = this;
                            t.load_next_period_info(), t.pagination.page = 1, t.load_guesses()
                        }
                    },
                    load_my_guesses: function() {
                        var t = this.my_pagination,
                            e = (t.sortBy, t.descending, t.page),
                            a = t.rowsPerPage,
                        ...
                        var o = this,
                            ...
                            l = s + "/win/my_guesses?t=" + r + "&category=" + n + "&p=" + e + "&p_size=" + a;
                        this.$ajax.get(l, {
                            headers: {
                                Authorization: "Token " + i
                            }
                        }).then((function(t) {
                            if (o.loading_dialog = !1, o.my_guess_table_loading = !1, 200 == t.data.code) {
                                var e = t.data.page,
                                    a = t.data.queryset;
                                o.total_my_guess = e.count, o.my_guesses = a
                            }
                        })).catch((function(t) {
                            o.loading_dialog = !1, o.my_guess_table_loading = !1, console.log(t), t.response && 401 == t.response.status && (localStorage.removeItem("coem.token"), o.$store.state.accessToken = null, location.href = "/#/login")
                        }))
                    },
                    load_guesses: function() {
                        ...
                        var o = this,
                            s = this.$store.state.svrUrl,
                            r = Date.parse(new Date),
                            l = s + "/win/guesses?t=" + r + "&category=" + n + "&p=" + e + "&p_size=" + a;
                        this.$ajax.get(l, {
                            headers: {
                                Authorization: "Token " + i
                            }
                        }).then((function(t) {
                            if (o.guess_table_loading = !1, 200 == t.data.code) {
                                var e = t.data.page,
                                    a = t.data.queryset;
                                o.total_guess = e.count, o.guesses = a
                            }
                        })).catch((function(t) {
                            o.guess_table_loading = !1, console.log(t), t.response && 401 == t.response.status && (localStorage.removeItem("coem.token"), o.$store.state.accessToken = null, location.href = "/#/login")
                        }))
                    },
                    download_app: function() {
                        var t = Date.parse(new Date);
                ...
                created: function() {
                    if (this.$store.state.is_show_win_tab = localStorage.getItem("coem.is_early"), this.$store.state.is_show_win_tab) {
                        console.log("Win created"), this.$store.state.show_bottom_menu = !0;
                        var t = localStorage.getItem("coem.selected_category_index");
                        null == t && (localStorage.setItem("coem.selected_category_index", "0"), this.$store.state.selected_category_index = "0", this.tab = 0, this.selected_category_index = 0), this.load_next_period_info();
                        var e = (new Date).getTime();
                        this.$store.state.count_started_tag = e, this.start_count_down(e), document.addEventListener("visibilitychange", this.auto_reload_listener)
                    } else history.go(-1)
                },
                destroyed: function() {
                    console.log("Win destroyed"), document.removeEventListener("visibilitychange", this.auto_reload_listener)
                },
                data: function() {
                    return {
                        notice_content: "",
                        ...
                        contract_number: 1,
                        contract_money_array: [10, 100, 1e3, 1e4],
            ...
            Zt = a("fe57"),
            te = a("9a96"),
            ee = Object(d["a"])(Nt, qt, Et, !1, null, "625df6cb", null),
            ae = ee.exports;
        u()(ee, {
            VAlert: Ut["a"],
            VBtn: m["a"],
        ...
        var ie = function() {
                ...
                return i("div", {
                    ...
                    staticClass: "white--text"
                }, [t._v("Mine")]), i("v-spacer"), i("v-btn", {
                    attrs: {
                        icon: ""
                    },
                    on: {
                        click: function(e) {
                            return t.setting_click("recharge")
                        }
                    }
                }, [i("v-icon", [t._v("payments")])], 1), i("v-menu", {
                    attrs: {
                        "offset-y": ""
                    },
                    scopedSlots: t._u([{
                ...
                }, [i("v-list", t._l(t.settings, (function(e, a) {
                    return i("v-list-tile", {
                        key: a,
                        on: {
                            click: function(a) {
                                return t.setting_click(e.action)
                            }
                        }
                    }, [i("v-list-tile-title", [t._v(t._s(e.title))])], 1)
                })), 1)], 1)], 1), i("v-img", {
                    staticStyle: {
                        height: "140px",
                        "padding-left": "12px"
                ...
                })])])], 1)], 1), i("v-list", t._l(t.items, (function(e) {
                    ...
                    model: {
                        value: t.show_event_dialog,
                        callback: function(e) {
                            t.show_event_dialog = e
                        },
                        expression: "show_event_dialog"
                    }
                }, [i("v-card", [i("v-card-title", {
                    staticClass: "headline"
                }, [t._v(t._s(t.$t("main.notice")))]), i("v-card-text", [i("v-img", {
                    attrs: {
                        src: a("acf3")
                    }
            ...
            oe = {
                methods: {
                    setting_click: function(t) {
                        "recharge" == t ? this.goRecharge() : "change_nick_name" == t ? this.show_change_nick_name() : "notice" == t ? this.notice_dialog = !0 : "logout" == t && (this.logout_dialog = !0)
                    },
                    goRecharge: function() {
                        this.$router.push("/recharge")
                    },
                    show_change_nick_name: function() {
                        this.edit_nick_name = this.nick_name, this.change_nick_name_dialog = !0
                    },
                    confirm_change_nick_name: function() {
                        if ("" != this.edit_nick_name) {
                            ...
                            tt.post(this, "/user/change_nick_name", t, !0, (function(t, e) {
                                t.change_nick_name_btn_disabled = !1, t.change_nick_name_dialog = !1, 200 == e.data.code && t.loadProfile()
                            }))
                        }
                    },
                    menuClick: function(t) {
                        var e = this;
                        if ("/downloadAndroid" != t) void 0 != t && this.$router.push(t);
                        else {
                            var a = Date.parse(new Date);
                            tt.get(this, "/shop/home_top?t=" + a, !1, (function(t, a) {
                                var i = a.data.queryset;
                                if (i.length > 0) {
                                    var n = i[0],
                                        o = n.android_version;
                    ...
                    loadProfile: function() {
                        var t = Date.parse(new Date);
                        tt.get(this, "/user/profile?t=" + t, !0, (function(t, e) {
                            var a = e.data.entry;
                            t.r_code = a.r_code, t.nick_name = a.nick_name, t.mobile = a.mobile, t.user_id = a.user_id, t.balance = t.$t("main.currency_symbol") + " " + a.balance.toFixed(2), localStorage.setItem("coem.r_code", a.r_code), localStorage.setItem("coem.nick_name", a.nick_name), localStorage.setItem("coem.mobile", a.mobile), localStorage.setItem("coem.user_id", a.user_id), localStorage.setItem("coem.is_early", e.data.is_early), t.$store.state.is_show_win_tab = e.data.is_early
                        }))
                    },
                    logout: function() {
                        this.logout_dialog = !1, tt.post(this, "/user/logout", {}, !0, (function(t, e) {})), localStorage.removeItem("coem.token"), this.$router.push("/login")
                    },
                    loadHomeTop: function() {
                        this.$store.state.svrUrl;
                        var t = Date.parse(new Date);
                        tt.get(this, "/shop/home_top?t=" + t, !1, (function(t, e) {
                            var a = e.data.queryset;
                            if (a.length > 0) {
                                var i = a[0];
                                if (i.notice) {
                                    localStorage.setItem("coem.notice", i.notice);
                                    var n = "coem.notice.today";
                                    t.$cookies.isKey(n) && t.$cookies.get(n) == i.notice || (t.notice_content = i.notice, t.notice_dialog = !0, t.$cookies.set(n, i.notice, "1d"))
                                } else localStorage.removeItem("coem.notice")
                            }
                        }), (function(t, e) {
                            console.log("home_top load fail"), console.log(e.toString()), "Error: Network Error" == e.toString() && (t.notice_content = t.$t("msg.maintenance"), t.notice_dialog = !0)
                        }))
                ...
                beforeCreate: function() {
                    this.token = localStorage.getItem("coem.token"), null == this.token && this.$router.push("/login")
                },
                created: function() {
                    "Rxce" != this.$store.state.shopName && this.items.shift(), this.$store.state.show_bottom_menu = !0, this.loadProfile();
                    var t = localStorage.getItem("coem.notice");
                    t && (this.notify_icon_shows = !0, this.notice_content = t)
                },
                data: function() {
                    return {
                        show_event_dialog: !1,
                        ...
                        settings: [{
                            action: "notice",
                            title: this.$t("main.notice")
                        }, {
                            action: "change_nick_name",
                            title: this.$t("my.change_nick_name")
                        }, {
                            action: "logout",
                            title: this.$t("my.logout")
                        }],
                        items: [{
                            action: "loyalty",
                            title: this.$t("my.gift_event"),
                            link: "/giftEvent",
                            items: []
                        }, {
                            action: "list_alt",
            ...
            re = a("56b0"),
            le = a("e449"),
            ce = Object(d["a"])(se, ie, ne, !1, null, null, null),
            de = ce.exports;
        u()(ce, {
            VBtn: m["a"],
            VCard: v["a"],
            ...
            pe = {
                methods: {
                    ...
                    alertError: function(t) {
                        this.alert_text = t, this.alert_show = !0;
                        var e = this;
                        setTimeout((function() {
                            e.alert_show = !1
                        }), 8e3)
                    ...
                    login: function() {
                        if (this.mobile_number.length > 0 && this.password.length > 0) {
                            ...
                            tt.post(this, "/user/login", t, !1, (function(t, e) {
                                t.dialog = !1;
                                var a = e.data;
                                200 == a.code ? (localStorage.setItem("coem.token", a.token), t.$store.state.accessToken = a.token, t.$router.push("/mine")) : t.alertError(a.msg)
                            }))
                        }
                    }
                },
                ...
                methods: {
                    ...
                    send_sms: function() {
                        if (this.mobile_number.length > 0) {
                            this.otp_loading = !0, this.otp_down_count_change();
                            var t = {
                                mobile_number: this.mobile_number,
                                verify_type: "reset_password"
                            };
                            tt.post(this, "/user/send_verify_code", t, !1, (function(t, e) {
                                t.dialog = !1;
                                var a = e.data;
                                200 == a.code || t.alertError(a.msg)
                            }))
                        } else this.alertError("Mobile number is required")
                    },
                    otp_down_count_change: function() {
                        if (this.otp_down_count -= 1, this.otp_down_count <= 0) this.otp_loading = !1, this.otp_text = "OTP", this.otp_down_count = 60;
                        else {
                    ...
                    reset_callback: function() {
                        this.reset_result_dialog = !1, this.back()
                    },
                    resetPassword: function() {
                        if (this.mobile_number.length > 0 && this.verify_code.length > 0 && this.password.length > 0) {
                            ...
                            tt.put(this, "/user/reset_password", t, !1, (function(t, e) {
                                t.dialog = !1;
                                var a = e.data;
                                200 == a.code ? t.reset_result_dialog = !0 : t.alertError(a.msg)
                            }))
                        }
                    }
                },
            ...
            $e = {
                methods: {
                    ...
                    send_sms: function() {
                        ...
                        } else this.alertError(this.$t("my.mb_required"))
                    },
                    otp_down_count_change: function() {
                        if (this.otp_down_count -= 1, this.otp_down_count <= 0) this.otp_loading = !1, this.otp_text = "OTP", this.otp_down_count = 60;
                        else {
                    ...
                    register: function() {
                        if (this.agree_privacy_policy && this.mobile_number.length > 0 && this.verify_code.length > 0 && this.password.length > 0 && this.r_code.length > 0) {
                            ...
                            tt.post(this, "/user/register", t, !1, (function(t, e) {
                                t.dialog = !1;
                                var a = e.data;
                                200 == a.code ? (localStorage.setItem("coem.token", a.token), t.$store.state.accessToken = a.token, t.register_result_dialog = !0) : t.alertError(a.msg)
                            }))
                        }
                    },
        ...
        var Pe = function() {
            ...
            Ie = {
                methods: {
                    ...
                    addressClick: function(t, e) {
                        0 == t ? this.$router.push("/editAddress") : (this.selected_address_id = t, this.selected_address_text = e, this.address_select_active = !1)
                    },
                    loadItem: function() {
                        var t = this.$route.query.id;
                        this.product_id = t, tt.get(this, "/shop/product?id=" + t, !1, (function(t, e) {
                            var a = e.data.entry;
                            a.price = t.$t("main.currency_symbol") + " " + a.price, a.main_image = urlPrefix + a.main_image, t.product = a
                        }))
                    },
                ...
                created: function() {
                    this.loadItem(), this.loadAddresses()
                },
                data: function() {
                    return {
                        buy_result_dialog: !1,
            ...
            De = Ie,
            qe = Object(d["a"])(De, Pe, je, !1, null, null, null),
            Ee = qe.exports;
        u()(qe, {
            VAlert: Ut["a"],
            VBtn: m["a"],
        ...
        var Ye = function() {
                ...
                return a("div", [a("v-toolbar", {
                ...
                }, [a("v-icon", [t._v("arrow_back")])], 1), a("v-toolbar-title", [t._v(t._s(t.$t("my.gift_event")))]), a("v-spacer"), a("v-btn", {
                    attrs: {
                        icon: "",
                        disabled: t.tableLoading
                    },
                    on: {
                        click: t.loadEvents
                    }
                }, [a("v-icon", [t._v("refresh")])], 1)], 1), a("v-subheader", {
                    staticStyle: {
                        margin: "72px 0"
                    }
                }, [t._v("\n    Gift activities: Red envelope gifts are randomly distributed, and if the basic conditions are met , they can participate. The event is carried out thrice a day, and each round is given 30lac\n    RS randomly."), a("br"), t._v("\n\n    Activity time:"), a("br"), t._v("\n    First round: 10:30-11:30"), a("br"), t._v("\n    Second round: 15:30-16:30"), a("br"), t._v("\n    The third round: 20:30-21:30"), a("br")]), a("v-data-table", {
                    staticClass: "elevation-1",
                    attrs: {
                        headers: t.headers,
                        items: t.events,
                    ...
                    scopedSlots: t._u([{
                        ...
                        fn: function(e) {
                            return [a("td", {
                                staticClass: "text-xs-center",
                                style: e.item.completed ? "color:#BDBDBD" : "",
                                on: {
                                    click: function(a) {
                                        return t.eventDetail(e.item)
                                    }
                                }
                            }, [t._v(t._s(e.item.time))]), a("td", {
                                staticClass: "text-xs-center",
                                style: e.item.completed ? "color:#BDBDBD" : "",
                                on: {
                                    click: function(a) {
                    ...
                    staticClass: "headline"
                }, [t._v("Event Details")]), a("v-card-text", [t._v("\n        This event started at " + t._s(t.selectItem.time) + ", can receive " + t._s(t.selectItem.receive) + "."), a("br"), t._v("\n        Open gift can obtain random money to your wallet"), a("br"), a("div", {
                    staticStyle: {
                        "text-align": "center",
                        "margin-top": "24px"
                    }
                    ...
                    attrs: {
                        color: "primary",
                        disabled: t.openGiftBtnDisabled
                    },
                    on: {
                        click: function(e) {
                            return t.openGift(t.selectItem)
                        }
                    }
                }, [t._v("Open Gift")])], 1)]), a("v-card-actions", [a("v-spacer"), a("v-btn", {
                    attrs: {
                        color: "grey darken-2",
                        flat: ""
                    },
            ...
            Ae = {
                ...
                methods: {
                    ...
                    openGift: function(t) {
                        this.openGiftBtnDisabled = !0, this.dialog = !1;
                        var e = {
                            id: t.id
                        };
                        tt.post(this, "/user/join_gift_event", e, !0, (function(t, e) {
                            200 == e.data.code ? (t.result_title = t.$t("main.completed"), t.result_content = "Congratulations! You got " + e.data.price, t.result_dialog = !0) : (t.result_title = t.$t("main.fail"), t.result_content = e.data.msg, t.result_dialog = !0)
                        }))
                    },
                    eventDetail: function(t) {
                        this.tableLoading || t.completed || (this.openGiftBtnDisabled = !1, this.selectItem = t, this.dialog = !0)
                    },
                    loadEvents: function() {
                        var t = this;
                        this.tableLoading = !0, tt.get(this, "/user/gift_events", !0, (function(e, a) {
                            if (e.tableLoading = !1, 200 == a.data.code) {
                                var i = [];
                                for (var n in a.data.queryset) {
                                    var o = a.data.queryset[n],
                                        s = {
                                            id: o.id,
                                            time: o.start_time + " ~ " + o.end_time,
                                            receive: o.member_available_num + " times",
                                            requirements: "Recharge >= " + o.join_recharge + " " + o.join_relation + " game join >= " + o.join_bet,
            ...
            ze = Ae,
            Be = a("e0c7"),
            Re = Object(d["a"])(ze, Ye, Le, !1, null, null, null),
            We = Re.exports;
        u()(Re, {
            VBtn: m["a"],
            VCard: v["a"],
        ...
        var Oe = function() {
            ...
            Ue = Ne,
            Me = a("288c"),
            Ge = Object(d["a"])(Ue, Oe, Fe, !1, null, null, null),
            He = Ge.exports;
        u()(Ge, {
            VAvatar: A["a"],
            VBottomSheet: Me["a"],
        ...
        var Ke = function() {
                ...
                return a("div", {
                ...
                }, [t._v("\n    Note: If the recharge amount is deducted but the amount is not added to the account, please send a detailed screenshot of the payment and the game ID to the mailbox for processing.\n  ")]), a("v-card", ["" != t.contact_url ? a("div", {
                ...
                }, [t._v("\n      Any problem? Contact\n      "), t.contact_url.startsWith("https://api.whatsapp.com/send") ? a("a", {
                    attrs: {
                        href: t.contact_url
                    }
                }, [t._v("WhatsApp")]) : t.contact_url.startsWith("tel:") ? a("a", {
                    attrs: {
                        href: t.contact_url
                    }
                }, [t._v(t._s(t.contact_url.substring(4)))]) : t.contact_url.startsWith("mailto:") ? a("a", {
                    attrs: {
                        href: t.contact_url
                    }
                }, [t._v(t._s(t.contact_url.substring(7)))]) : t._e()]) : t._e(), a("form", {
                    ref: "form",
                    attrs: {
                        "lazy-validation": "",
                        action: "javascript:;"
                    ...
                    model: {
                        value: t.pay_upi,
                        callback: function(e) {
                            t.pay_upi = "string" === typeof e ? e.trim() : e
                        },
                        expression: "pay_upi"
                    }
                })], 1)], 1), a("v-layout", {
            ...
            Qe = (a("ac6a"), {
                methods: {
                    ...
                    limit_number: function(t) {
                        t.target.value = t.target.value.replace(/[^\d]/g, "")
                    },
                    common_info_auto_fill: function() {
                        this.pay_name = localStorage.getItem("coem.common_info_pay_name"), this.pay_mobile = localStorage.getItem("coem.common_info_pay_mobile"), this.pay_email = localStorage.getItem("coem.common_info_pay_email")
                    },
                    upi_auto_fill: function() {
                        this.pay_name = localStorage.getItem("coem.upi_pay_name"), this.pay_mobile = localStorage.getItem("coem.upi_pay_mobile"), this.pay_upi = localStorage.getItem("coem.upi_pay_upi"), this.pay_email = localStorage.getItem("coem.upi_pay_email")
                    },
                    cashfree_auto_fill: function() {
                        this.pay_name = localStorage.getItem("coem.cashfree_pay_name"), this.pay_mobile = localStorage.getItem("coem.cashfree_pay_mobile"), this.pay_email = localStorage.getItem("coem.cashfree_pay_email")
                    },
                    myepay_auto_fill: function() {
                        this.pay_name = localStorage.getItem("coem.myepay_pay_name"), this.pay_mobile = localStorage.getItem("coem.myepay_pay_mobile"), this.pay_email = localStorage.getItem("coem.myepay_pay_email")
                    },
                    common_info_dialog_continue: function() {
                        if (0 != this.pay_name.length && 0 != this.pay_mobile.length && 0 != this.pay_email.length) {
                            localStorage.setItem("coem.common_info_pay_name", this.pay_name), localStorage.setItem("coem.common_info_pay_mobile", this.pay_mobile), localStorage.setItem("coem.common_info_pay_email", this.pay_email), this.common_info_dialog = !1, this.dialog = !0;
                            var t = this.price,
                                e = {
                                    price: t.toString(),
                            ...
                            tt.post(this, "/user/add_recharge", e, !0, (function(t, e) {
                                t.dialog = !1, 200 == e.data.code ? "razorpay" == t.current_pay_key ? t.razor_pay_url_200_callback(t, e) : "ka" == t.current_pay_key ? t.ka_200_callback(t, e) : "mpurse" == t.current_pay_key ? t.mpurse_200_callback(t, e) : "ekpay" == t.current_pay_key || e.data.data_dict ? t.ek_pay_200_callback(t, e) : t.common_pay_url_200_callback(t, e) : (t.result_title = t.$t("main.fail"), t.result_content = e.data.msg, t.recharge_commit = !1, t.result_dialog = !0)
                            }), (function(t, e) {
                                t.dialog = !1
                            }))
                        } else console.log("pay_name or pay_mobile or pay_email empty")
                    },
                    common_pay_url_200_callback: function(t, e) {
                        var a = e.data.pay_url;
                        location.href = a
                    },
                    ek_pay_200_callback: function(t, e) {
                        var a = document.getElementById("myepay_form");
                        a && a.remove();
                        var i = document.createElement("form");
                        i.id = "myepay_form", i.name = "myepay_form", i.method = "post", i.action = e.data.gateway, document.body.appendChild(i);
                        var n = e.data.data_dict;
                        for (var o in n) {
                            console.log("key: " + o), console.log("value: " + n[o]);
                            var s = document.createElement("input");
                            s.type = "text", s.name = o, s.value = n[o], i.appendChild(s)
                        }
                        i.submit()
                    },
                    razor_pay_url_200_callback: function(t, e) {
                        var a = e.data.options;
                        a["name"] = t.$store.state.shopName, a["image"] = t.$store.state.imgUrl + "/logo/app.png", a["theme"] = {
                            color: "#009688"
                        };
                        var i = new Razorpay(a);
                        i.open()
                    },
                    mpurse_200_callback: function(t, e) {
                        var a = e.data.upi_account,
                            i = e.data.price,
                            n = e.data.serial_number,
                            o = "upi_account=" + a + "&price=" + i + "&serial_number=" + n;
                        this.$router.push("/transferPayment?" + o)
                    },
                    ka_200_callback: function(t, e) {
                        var a = t.current_pay_key + "_form",
                            i = document.getElementById(a);
                        i && i.remove();
                        var n = document.createElement("form");
                        n.id = a, n.name = a, n.method = "post", n.action = e.data.data_dict.gateway, document.body.appendChild(n);
                        var o = e.data.data_dict;
                        for (var s in o) {
                            console.log("key: " + s), console.log("value: " + o[s]);
                            var r = document.createElement("input");
                            r.type = "text", r.name = s, r.value = o[s], n.appendChild(r)
                        }
                        n.submit()
                    },
                    upi_dialog_continue: function() {
                        if (0 != this.pay_name.length && 0 != this.pay_mobile.length && 0 != this.pay_upi.length && 0 != this.pay_email.length) {
                            localStorage.setItem("coem.upi_pay_name", this.pay_name), localStorage.setItem("coem.upi_pay_mobile", this.pay_mobile), localStorage.setItem("coem.upi_pay_upi", this.pay_upi), localStorage.setItem("coem.upi_pay_email", this.pay_email), this.upi_dialog = !1, this.dialog = !0;
                            var t = this.price,
                                e = {
                                    price: t.toString(),
                                    pay_key: "ACF",
                            ...
                            tt.post(this, "/user/add_recharge", e, !0, (function(t, e) {
                                if (t.dialog = !1, 200 == e.data.code) {
                                    var a = e.data.pay_url;
                                    location.href = t.$store.state.svrUrl + a
                                } else t.result_title = t.$t("main.fail"), t.result_content = e.data.msg, t.recharge_commit = !1, t.result_dialog = !0
                            }), (function(t, e) {
                                t.dialog = !1
                            }))
                        } else console.log("pay_name or pay_mobile or pay_upi or pay_email empty")
                    },
                    cashfree_dialog_continue: function() {
                        if (0 != this.pay_name.length && 0 != this.pay_mobile.length && 0 != this.pay_email.length) {
                            localStorage.setItem("coem.cashfree_pay_name", this.pay_name), localStorage.setItem("coem.cashfree_pay_mobile", this.pay_mobile), localStorage.setItem("coem.cashfree_pay_email", this.pay_email), this.cashfree_dialog = !1, this.dialog = !0;
                            var t = this.price,
                                e = {
                                    price: t.toString(),
                                    pay_key: "cashfree",
                            ...
                            tt.post(this, "/user/add_recharge", e, !0, (function(t, e) {
                                if (t.dialog = !1, 200 == e.data.code) {
                                    ...
                                    document.getElementById("pay_md5sign").value = a.pay_md5sign, document.getElementById("pay_memberid").value = a.pay_memberid, document.getElementById("pay_orderid").value = a.pay_orderid, document.getElementById("pay_applydate").value = a.pay_applydate, document.getElementById("pay_bankcode").value = a.pay_bankcode, document.getElementById("pay_notifyurl").value = a.pay_notifyurl, document.getElementById("pay_callbackurl").value = a.pay_callbackurl, document.getElementById("pay_amount").value = a.pay_amount, document.getElementById("pay_name").value = a.pay_name, document.getElementById("pay_mobile").value = a.pay_mobile, document.getElementById("pay_email").value = a.pay_email, document.recharge_form.action = a.gateway, document.recharge_form.submit()
                                } else t.result_title = t.$t("main.fail"), t.result_content = e.data.msg, t.recharge_commit = !1, t.result_dialog = !0
                            }), (function(t, e) {
                                t.dialog = !1
                            }))
                    ...
                    myepay_dialog_continue: function() {
                        if (0 != this.pay_name.length && 0 != this.pay_mobile.length && 0 != this.pay_email.length) {
                            localStorage.setItem("coem.myepay_pay_name", this.pay_name), localStorage.setItem("coem.myepay_pay_mobile", this.pay_mobile), localStorage.setItem("coem.myepay_pay_email", this.pay_email), this.myepay_dialog = !1, this.dialog = !0;
                            var t = this.price,
                                e = {
                                    price: t.toString(),
                                    pay_key: "MYEPAYWEB",
                    ...
                    result_dialog_btn_click: function() {
                        this.result_dialog = !1, this.recharge_commit && this.back()
                    },
                    add_recharge: function() {
                        var t = this.price;
                        if ("" == t || isNaN(t)) console.log("price empty");
                        else {
                            var e = this.channels[this.selected_payment_index].key;
                            if (console.log(e), this.current_pay_key = e, "ACF" == e) {
                                this.pay_name = "", this.pay_mobile = "", this.pay_upi = "", this.pay_email = "";
                                var a = localStorage.getItem("coem.upi_pay_name");
                                null != a && a.length > 0 ? this.upi_autofill_enabled = !0 : this.upi_autofill_enabled = !1, this.upi_dialog = !0
                            } else if ("cashfree" == e) {
                                this.pay_name = "", this.pay_mobile = "", this.pay_email = "";
                                var i = localStorage.getItem("coem.cashfree_pay_name");
                                null != i && i.length > 0 ? this.cashfree_autofill_enabled = !0 : this.cashfree_autofill_enabled = !1, this.cashfree_dialog = !0
                            } else if ("MYEPAYWEB" == e) {
                                this.pay_name = "", this.pay_mobile = "", this.pay_email = "";
                                var n = localStorage.getItem("coem.myepay_pay_name");
                                null != n && n.length > 0 ? this.myepay_autofill_enabled = !0 : this.myepay_autofill_enabled = !1, this.myepay_dialog = !0
                            } else {
                                this.pay_name = "", this.pay_mobile = "", this.pay_email = "";
                                var o = localStorage.getItem("coem.common_info_pay_name");
                                null != o && o.length > 0 ? this.common_info_autofill_enabled = !0 : this.common_info_autofill_enabled = !1, this.common_info_dialog = !0
                            }
                        }
                    },
                    selectPayment: function(t) {
                        this.selected_payment_index = t, this.show_payments(this.channels)
                    },
                    selectAmount: function(t, e) {
                        document.getElementsByName("amountButton").forEach((function(t) {
                            t.className = "v-btn theme--light"
                        })), t.currentTarget.className = "v-btn theme--light info", this.price = e
                    },
                    loadProfile: function() {
                        var t = localStorage.getItem("coem.token"),
                            e = this,
                    ...
                    load_channels: function() {
                        tt.get(this, "/user/channels?type=pay", !0, (function(t, e) {
                            200 == e.data.code && (t.contact_url = e.data.contact_url, t.channels = e.data.queryset, t.selected_payment_index = 0, t.show_payments(t.channels))
                        }))
                    },
                    show_payments: function(t) {
                        ...
                        for (var a in t) {
                            var i = t[a],
                                n = "";
                            a == this.selected_payment_index && (n = "done", this.selected_channel_name = i.name), e.push({
                                icon: n,
                                title: i.name
                            })
                        }
                    ...
                    add_complaints: function() {
                        this.$router.push("/addSuggestion?t=recharge")
                    }
                },
                watch: {
                    selected_payment_index: function() {
                        var t = this.channels[this.selected_payment_index];
                        this.amounts = t.fixed_amounts.split(","), this.price = ""
                    }
                },
                created: function() {
                    this.loadProfile(), this.load_channels()
                },
                data: function() {
                    return {
                        contact_url: "",
            ...
            ia = {
                methods: {
                    ...
                    addBankCard: function() {
                        location.href = "/#/editBankCard"
                    },
                    infoClick: function(t, e, a) {
                        this.active_item_id = t, this.sheet = !0, this.will_delete_bank_card_text = e + " " + a
                    },
                    sheetAction: function(t) {
                        this.sheet = !1, "edit" == t ? location.href = "/#/editBankCard?id=" + this.active_item_id : "delete" == t && (this.delete_dialog = !0)
                    },
        ...
        var ra = function() {
                ...
                }), "in" == t.$i18n.locale ? a("v-text-field", {
                    attrs: {
                        color: "primary",
            ...
            ca = {
                methods: {
                    ...
                    loadBankCard: function() {
                        var t = localStorage.getItem("coem.token"),
                            e = this,
                            a = this.$store.state.svrUrl,
                            i = a + "/user/bank_card?id=" + this.request_id;
                        this.$ajax.get(i, {
                            headers: {
                                Authorization: "Token " + t
                            }
                            ...
                            var a = t.data.entry;
                            e.actual_name = a.actual_name, e.ifsc_code = a.ifsc_code, e.bank_name = a.bank_name, e.account_number = a.account_number, e.province = a.province, e.city = a.city, e.address = a.address, e.mobile_number = a.mobile_number, e.email = a.email, e.upi_account = a.upi_account
                        })).catch((function(t) {
                            console.log(t), t.response && 401 == t.response.status && (localStorage.removeItem("coem.token"), e.$store.state.accessToken = null, location.href = "/#/login")
                        }))
                    },
                    continueEdit: function() {
                        this.dialog = !0, "vi" == this.$i18n.locale && (this.ifsc_code = "None");
                        var t = {
                            id: this.request_id,
                            ...
                            mobile_number: this.mobile_number,
                            email: this.email,
                            upi_account: this.upi_account
                        };
                        tt.post(this, "/user/edit_bank_card", t, !0, (function(t, e) {
                            t.dialog = !1;
                            var a = e.data;
                ...
                created: function() {
                    this.request_id = this.$route.query.id, this.request_id ? (this.title = this.$t("my.edit_bank_card"), this.loadBankCard()) : this.title = this.$t("my.add_bank_card")
                },
                data: function() {
                    var t = this;
                    return {
            ...
            da = ca,
            _a = Object(d["a"])(da, ra, la, !1, null, null, null),
            ua = _a.exports;
        u()(_a, {
            VAlert: Ut["a"],
            VBtn: m["a"],
        ...
        var pa = function() {
            ...
            va = {
                methods: {
                    ...
                    infoClick: function(t, e, a) {
                        this.active_item_id = t, this.sheet = !0, this.will_delete_address_text = e + " " + a
                    },
                    sheetAction: function(t) {
                        this.sheet = !1, "edit" == t ? this.$router.push("/editAddress?id=" + this.active_item_id) : "delete" == t && (this.delete_dialog = !0)
                    },
            ...
            ha = va,
            ga = Object(d["a"])(ha, pa, ma, !1, null, null, null),
            fa = ga.exports;
        u()(ga, {
            VAvatar: A["a"],
            VBottomSheet: Me["a"],
        ...
        var ya = function() {
            ...
            xa = {
                methods: {
                    ...
                    loadAddress: function() {
                        ...
                        this.$ajax.get(i, {
                            ...
                            var a = t.data.entry;
                            e.full_name = a.full_name, e.mobile_number = a.mobile_number, e.pin_code = a.pin_code, e.state = a.state, e.town_city = a.town_city, e.detail_address = a.detail_address
                        })).catch((function(t) {
                            console.log(t), t.response && 401 == t.response.status && (localStorage.removeItem("coem.token"), e.$store.state.accessToken = null, location.href = "/#/login")
                        }))
                    },
                ...
                created: function() {
                    this.address_id = this.$route.query.id, this.address_id ? (this.title = this.$t("my.edit_address"), this.loadAddress()) : this.title = this.$t("my.add_address")
                },
                data: function() {
                    return {
                        alert_show: !1,
            ...
            wa = xa,
            ka = a("a844"),
            Sa = Object(d["a"])(wa, ya, ba, !1, null, null, null),
            $a = Sa.exports;
        u()(Sa, {
            VAlert: Ut["a"],
            VBtn: m["a"],
        ...
        var Ca = function() {
            ...
            Pa = Ta,
            ja = Object(d["a"])(Pa, Ca, Va, !1, null, null, null),
            Ia = ja.exports;
        u()(ja, {
            VBtn: m["a"],
            VIcon: h["a"],
        ...
        var Da = function() {
            ...
            Ya = Ea,
            La = Object(d["a"])(Ya, Da, qa, !1, null, null, null),
            Aa = La.exports;
        u()(La, {
            VBtn: m["a"],
            VIcon: h["a"],
        ...
        var za = function() {
            ...
            Ra = {
                methods: {
                    ...
                    load_guesses: function() {
                        ...
                        var o = this,
                            s = this.$store.state.svrUrl,
                            r = s + "/win/guesses?category=" + n + "&p=" + e + "&p_size=" + a;
                        this.$ajax.get(r, {
                            headers: {
                                Authorization: "Token " + i
                            }
                ...
                created: function() {
                    this.$store.state.is_show_win_tab ? this.category_value = this.$route.query.category_value : history.go(-1)
                },
                data: function() {
                    return {
                        category_title_map: {
            ...
            Wa = Ra,
            Oa = (a("df7e"), Object(d["a"])(Wa, za, Ba, !1, null, null, null)),
            Fa = Oa.exports;
        u()(Oa, {
            VBtn: m["a"],
            VCard: v["a"],
        ...
        var Na = function() {
            ...
            Ma = {
                ...
                methods: {
                    ...
                    load_my_guesses: function() {
                        ...
                        var o = this,
                            s = this.$store.state.svrUrl,
                            r = s + "/win/my_guesses?category=" + n + "&p=" + e + "&p_size=" + a;
                        this.$ajax.get(r, {
                            headers: {
                                Authorization: "Token " + i
                            }
                        }).then((function(t) {
                            if (o.my_guess_table_loading = !1, 200 == t.data.code) {
                                var e = t.data.page,
                                    a = t.data.queryset;
                                o.total_my_guess = e.count, o.my_guesses = a
                            }
                        })).catch((function(t) {
                            o.my_guess_table_loading = !1, console.log(t), t.response && 401 == t.response.status && (localStorage.removeItem("coem.token"), o.$store.state.accessToken = null, location.href = "/#/login")
                        }))
                    }
                },
                watch: {
            ...
            Ga = Ma,
            Ha = (a("a94e"), Object(d["a"])(Ga, Na, Ua, !1, null, null, null)),
            Ka = Ha.exports;
        u()(Ha, {
            VBtn: m["a"],
            VCard: v["a"],
                    ...
                    scopedSlots: t._u([{
                        ...
                        fn: function(e) {
                            return [a("v-list", {
                                ...
                                ["HRE", "RE"].indexOf(e.item.type) >= 0 ? a("v-icon", {
                                    staticClass: "green white--text"
                                }, [t._v("\n                account_balance_wallet\n              ")]) : t._e(), "HREC" == e.item.type ? a("v-icon", {
                                    staticClass: "red white--text"
                                }, [t._v("\n                account_balance_wallet\n              ")]) : t._e(), "WD" == e.item.type ? a("v-icon", {
                                    staticClass: "red white--text"
                                }, [t._v("monetization_on")]) : t._e(), "WDR" == e.item.type ? a("v-icon", {
                                    staticClass: "green white--text"
                                }, [t._v("monetization_on")]) : t._e(), "WDF" == e.item.type ? a("v-icon", {
                                    staticClass: "red white--text"
                                }, [t._v("attach_money")]) : t._e(), "ORD" == e.item.type ? a("v-icon", {
                                    staticClass: "red white--text"
                                }, [t._v("shopping_cart")]) : t._e(), "GU" == e.item.type ? a("v-icon", {
                                    staticClass: "red white--text"
                                }, [t._v("emoji_events")]) : t._e(), "GUW" == e.item.type ? a("v-icon", {
                                    staticClass: "green white--text"
                                }, [t._v("emoji_events")]) : t._e(), "GUP" == e.item.type ? a("v-icon", {
                                    staticClass: "green white--text"
                                }, [t._v("assessment")]) : t._e(), "RP" == e.item.type ? a("v-icon", {
                                    staticClass: "green white--text"
                                }, [t._v("redeem")]) : t._e(), "REG" == e.item.type ? a("v-icon", {
                                    staticClass: "green white--text"
                                }, [t._v("loyalty")]) : t._e()
                            ...
                            }, ["HREC" == e.item.type ? a("v-list-tile-title", [t._v(t._s(t.$t("my.recharge_cancel")) + "\n              ")]) : t._e(), ["HRE", "RE"].indexOf(e.item.type) >= 0 ? a("v-list-tile-title", [t._v(t._s(t.$t("my.recharge")) + "\n              ")]) : t._e(), "WD" == e.item.type ? a("v-list-tile-title", [t._v(t._s(t.$t("my.withdrawal")))]) : t._e(), "WDR" == e.item.type ? a("v-list-tile-title", [t._v(t._s(t.$t("my.withdrawal_reject")))]) : t._e(), "WDF" == e.item.type ? a("v-list-tile-title", [t._v(t._s(t.$t("my.withdrawal_fee")))]) : t._e(), "ORD" == e.item.type ? a("v-list-tile-title", [t._v(t._s(t.$t("my.order_cost")))]) : t._e(), "GU" == e.item.type ? a("v-list-tile-title", [t._v(t._s(t.$t("my.join_period")))]) : t._e(), "GUW" == e.item.type ? a("v-list-tile-title", [t._v(t._s(t.$t("my.period_win")))]) : t._e(), "GUP" == e.item.type ? a("v-list-tile-title", [t._v(t._s(t.$t("my.profit_from_promotion")) + "\n              ")]) : t._e(), "RP" == e.item.type ? a("v-list-tile-title", [t._v(t._s(t.$t("my.receive_gift")) + "\n              ")]) : t._e(), "REG" == e.item.type ? a("v-list-tile-title", [t._v(t._s(t.$t("my.receive_event_gift")) + "\n              ")]) : t._e(), a("v-list-tile-sub-title", {
                                staticStyle: {
                                    "font-size": "12px"
                                }
                            }, [t._v(t._s(t._f("date_format")(e.item.create_time)) + "\n              ")])], 1), a("v-list-tile-action", [
                                ["WD", "WDF", "ORD", "GU", "HREC"].indexOf(e.item.type) >= 0 ? a("v-list-tile-title", {
                                    staticStyle: {
                                        color: "red"
                                    }
                                }, [t._v("-" + t._s(e.item.change_balance) + "\n              ")]) : t._e(), ["HRE", "RE", "GUW", "GUP", "RP", "REG", "WDR"].indexOf(e.item.type) >= 0 ? a("v-list-tile-title", {
                                    staticStyle: {
                                        color: "green"
                                    }
                                }, [t._v("\n                +" + t._s(e.item.change_balance) + "\n              ")]) : t._e()
                            ], 1)], 1)], 1)]
                        }
                    }])
                })], 1)], 1)
                ...
                methods: {
                    ...
                    load_transactions: function() {
                        ...
                        var n = this,
                            ...
                            s = o + "/user/transactions?p=" + e + "&p_size=" + a;
                        this.$ajax.get(s, {
                            headers: {
                                Authorization: "Token " + i
                            }
                        }).then((function(t) {
                            if (n.table_loading = !1, 200 == t.data.code) {
                                var e = t.data.page,
                                    a = t.data.queryset;
                                n.total_transaction = e.count, n.items = a
                            }
                        })).catch((function(t) {
                            n.table_loading = !1, console.log(t), t.response && 401 == t.response.status && (localStorage.removeItem("coem.token"), n.$store.state.accessToken = null, location.href = "/#/login")
                        }))
                    }
                },
                watch: {
        ...
        var ai = function() {
                ...
                return a("div", {
                ...
                }, [t._v(t._s(t.contact_url.substring(7)))]) : t._e()]) : t._e(), a("v-card", [a("v-container", {
                    attrs: {
                        fluid: "",
                        "grid-list-md": ""
                    }
                ...
                }, [t._v(t._s(t.$t("my.fee")) + ":" + t._s(t.fee) + ",\n            " + t._s(t.$t("my.to_account")) + "\n            " + t._s(t.to_account))]), a("v-list", [a("v-subheader", [t._v(t._s(t.$t("my.payout")))]), t._l(t.payouts, (function(e, i) {
                    return a("v-list-tile", {
                        key: e.title,
                        attrs: {
                            disabled: t.dialog
                ...
                })), 1)], 1), t.show_fushrshin_bank_select ? a("v-list", [a("v-list-group", {
                    attrs: {
                    ...
                    scopedSlots: t._u([{
                        key: "activator",
                        fn: function() {
                            return [a("v-list-tile", [a("v-list-tile-content", [a("v-list-tile-title", [t._v(t._s(t.selected_bank_text))])], 1)], 1)]
                        },
                        proxy: !0
                    }], null, !1, 2994370877),
                    model: {
                        value: t.bank_select_active,
                        callback: function(e) {
                            t.bank_select_active = e
                        },
                        expression: "bank_select_active"
                    }
                }, t._l(t.bank_options, (function(e) {
                    return a("v-list-tile", {
                        key: e.id,
                        on: {
                            click: function(a) {
                                return t.bankClick(e.code, e.name)
                            }
                        }
                    }, [a("v-list-tile-content", [a("v-list-tile-title", [t._v(t._s(e.name))])], 1)], 1)
                })), 1)], 1) : t._e(), a("v-text-field", {
                    staticStyle: {
                        padding: "8px 16px 8px 16px"
                    },
                    attrs: {
                        color: "primary",
                        label: t.$t("my.enter_payment_pwd"),
                        "prepend-inner-icon": "vpn_key",
                        required: "",
                        type: "password",
                        disabled: t.dialog
            ...
            ni = {
                methods: {
                    ...
                    selectPayout: function(t) {
                        this.selected_payout_index = t, this.show_payouts(this.channels)
                    },
                    show_payouts: function(t) {
                        ...
                        for (var a in t) {
                            var i = t[a],
                                n = "";
                            a == this.selected_payout_index && (n = "done"), e.push({
                                icon: n,
                                title: i.name
                            })
                        }
                    ...
                    load_channels: function() {
                        tt.get(this, "/user/channels?type=withdrawal", !0, (function(t, e) {
                            200 == e.data.code && (t.contact_url = e.data.contact_url, t.channels = e.data.queryset, t.selected_payout_index = 0, t.show_payouts(t.channels))
                        }))
                    },
                    go_record: function() {
                        location.href = "/#/withdrawalRecord"
                    },
                    bankClick: function(t, e) {
                        this.selected_bank_code = t, this.selected_bank_text = e, this.bank_select_active = !1
                    },
                    bankCardClick: function(t, e) {
                        0 == t ? location.href = "/#/editBankCard" : (this.selected_bank_card_id = t, this.selected_bank_card_text = e, this.bank_card_select_active = !1)
                    },
                    add_withdrawal: function() {
                        if (0 != this.amount.length && 0 != this.login_password.length && this.selected_bank_card_id) {
                            ...
                            if (!this.show_fushrshin_bank_select || null != this.selected_bank_code) {
                                this.dialog = !0;
                                var e = {
                                    amount: this.amount,
                                    ...
                                    withdrawal_key: t,
                                    bank_code: this.selected_bank_code
                                };
                                tt.post(this, "/user/add_withdrawal", e, !0, (function(t, e) {
                                    t.dialog = !1;
                                    var a = e.data;
                                    200 == a.code ? t.result_dialog = !0 : t.alertError(a.msg)
                                }))
                            }
                        }
                    },
                    ...
                    loadBankCards: function() {
                        ...
                        this.$ajax.get(i, {
                            ...
                            for (var n in a) {
                                ...
                                i.push({
                                    id: o.id,
                                    title: o.actual_name + " " + o.account_number
                                })
                            }
                            i.push({
                                id: 0,
                ...
                created: function() {
                    this.loadProfile(), this.loadBankCards(), this.load_channels()
                },
                computed: {
                    fee: function() {
                    ...
                    to_account: function() {
                        if (null == this.amount || "" == this.amount || isNaN(this.amount)) return 0;
                        var t = parseFloat(this.amount) - parseFloat(this.fee);
                        return t.toFixed(2)
                    }
                },
                watch: {
                    selected_payout_index: function() {
                        var t = this.channels[this.selected_payout_index],
                            e = t.bank_code_group_id;
                        if (parseInt(e) > 0) {
                            var a = t.bank_codes;
                            return this.bank_options = a, void(this.show_fushrshin_bank_select = !0)
                        }
                        this.show_fushrshin_bank_select = !1
                    }
                },
                data: function() {
                    return {
                        contact_url: "",
                        show_fushrshin_bank_select: !1,
                        alert_show: !1,
                        alert_text: "",
                        result_dialog: !1,
                        dialog: !1,
                        ...
                        bank_select_active: !1,
                        selected_bank_code: null,
                        selected_bank_text: this.$t("my.select_bank"),
                        bank_card_options: [{
                            id: 0,
                ...
                return a("div", {
                    ...
                    scopedSlots: t._u([{
                        ...
                        fn: function(e) {
                            ...
                            }, [a("v-list-tile-avatar", ["Success" == e.item.payout_status ? a("v-icon", {
                                staticClass: "green white--text"
                            }, [t._v("monetization_on")]) : "Reject" == e.item.status ? a("v-icon", {
                                staticClass: "red white--text"
                            }, [t._v("monetization_on")]) : a("v-icon", {
                                staticClass: "orange white--text"
                            }, [t._v("monetization_on")])], 1), a("v-list-tile-content", [a("v-list-tile-title", [t._v("\n                " + t._s(e.item.price) + "\n                "), "Success" == e.item.payout_status ? a("span", [t._v(t._s(t.$t("my.success")))]) : "Reject" == e.item.status ? a("span", [t._v(t._s(t.$t("my.fail")))]) : a("span", [t._v(t._s(t.$t("my.wait")))])]), "Reject" == e.item.status ? a("v-list-tile-sub-title", {
                                staticStyle: {
                                    "font-size": "12px"
                                }
                            ...
                            }, [t._v(t._s(t.$t("my.fee")) + ":" + t._s(e.item.fee) + ",\n                " + t._s(t.$t("my.to_account")) + "\n                " + t._s(e.item.actual_price) + "\n              ")]), null != e.item.fail_reason && e.item.fail_reason.length > 0 ? a("v-list-tile-sub-title", {
                                staticStyle: {
                                    "font-size": "12px",
                                    color: "red"
                                }
                            }, [t._v("\n                " + t._s(e.item.fail_reason) + "\n              ")]) : t._e()], 1), a("v-list-tile-action", {
                                staticStyle: {
                                    position: "absolute",
                                    right: "16px",
                                    top: "0"
            ...
            di = {
                ...
                methods: {
                    ...
                    load_withdrawals: function() {
                        ...
                        var n = this,
                            o = this.$store.state.svrUrl,
                            s = o + "/user/withdrawals?p=" + e + "&p_size=" + a;
                        this.$ajax.get(s, {
                            headers: {
                                Authorization: "Token " + i
                            }
                ...
                return a("div", {
                    ...
                    scopedSlots: t._u([{
                        ...
                        fn: function(e) {
                            ...
                            }, [a("v-list-tile-avatar", ["Wait" == e.item.status ? a("v-icon", {
                                staticClass: "orange white--text"
                            }, [t._v("account_balance_wallet")]) : t._e(), "Success" == e.item.status && e.item.price > 0 ? a("v-icon", {
                                staticClass: "green white--text"
                            }, [t._v("\n                account_balance_wallet\n              ")]) : t._e(), "Success" == e.item.status && e.item.price < 0 ? a("v-icon", {
                                staticClass: "red white--text"
                            }, [t._v("\n                account_balance_wallet\n              ")]) : t._e()], 1), a("v-list-tile-content", {
                                staticStyle: {
                                    height: "120px"
                                }
                            }, [a("v-list-tile-title", [t._v("\n                " + t._s(e.item.price) + "\n                "), "Success" == e.item.status ? a("span", [t._v(t._s(t.$t("my.success")))]) : t._e(), "Wait" == e.item.status ? a("span", [t._v(t._s(t.$t("my.wait")))]) : t._e()]), a("v-list-tile-sub-title", {
                                staticStyle: {
                                    "font-size": "12px"
                                }
                            }, [t._v(t._s(e.item.channel_name))])], 1), a("v-list-tile-action", [a("v-list-tile-sub-title", {
                                staticStyle: {
                                    "font-size": "12px"
                                }
                            }, [t._v(t._s(t._f("date_format")(e.item.create_time)) + "\n              ")])], 1)], 1)], 1)]
            ...
            hi = {
                ...
                methods: {
                    ...
                    load_recharges: function() {
                        ...
                        var n = this,
                            o = this.$store.state.svrUrl,
                            s = o + "/user/recharges?p=" + e + "&p_size=" + a;
                        this.$ajax.get(s, {
                            headers: {
                                Authorization: "Token " + i
                            }
        ...
        var bi = function() {
            ...
            wi = {
                methods: {
                    redeem_gift: function() {
                        ...
                        this.dialog = !0, tt.post(this, "/mana/receive_red_packet", t, !1, (function(t, e) {
                            t.dialog = !1, 200 == e.data.code ? (t.result_title = t.$t("main.completed"), t.result_content = t.$t("msg.redeem_success"), t.result_dialog = !0) : (t.result_title = t.$t("main.fail"), t.result_content = e.data.msg, t.result_dialog = !0)
                        }), (function(t, e) {
                            t.dialog = !1
                        }))
                    },
            ...
            ki = wi,
            Si = Object(d["a"])(ki, bi, xi, !1, null, null, null),
            $i = Si.exports;
        u()(Si, {
            VBtn: m["a"],
            VCard: v["a"],
        ...
        var Ci = function() {
                ...
                return a("div", {
                    ...
                    scopedSlots: t._u([{
                        ...
                        fn: function(e) {
                            return [a("v-list", {
                                ...
                                }, [t._v("WhatsApp: " + t._s(e.item.whats_app) + "\n                ")]), a("v-list-tile-sub-title", [t._v(t._s(e.item.serial_number))])], 1), a("v-list-tile-action", [a("v-list-tile-action-text", [t._v(t._s(t._f("date_format")(e.item.create_time)))]), "Completed" == e.item.status ? a("v-icon", {
                                    attrs: {
                                        color: "primary"
                                    }
                            ...
                            ], 2), e.index + 1 < t.list_items.length ? a("v-divider", {
                                key: e.index
                            }) : t._e()]
                        }
                    }])
                    ...
                    model: {
                        value: t.selected_item.supple_serial,
                        callback: function(e) {
                    ...
                    model: {
                        value: t.selected_item.whats_app,
                        callback: function(e) {
                ...
                })], 1), "Completed" == t.selected_item.status ? a("v-flex", {
                    attrs: {
                        xs12: "",
                        sm12: "",
                        "d-flex": ""
            ...
            Ti = {
                ...
                methods: {
                    ...
                    show_detail: function(t) {
                        this.selected_item = t, this.detail_dialog = !0
                    },
                    load_list: function() {
                        var t = this,
                            e = this.pagination,
                            a = (e.sortBy, e.descending, e.page),
                            i = e.rowsPerPage,
                            n = this.statuses[this.tab];
                        console.log("status:" + n), this.table_loading = !0;
                        var o = "/user/suggestions?status=" + n + "&p=" + a + "&p_size=" + i;
                        tt.get(this, o, !0, (function(e, a) {
                            if (t.table_loading = !1, 200 == a.data.code) {
                                var i = a.data.page,
                                    n = a.data.queryset;
                                e.total = i.count, e.list_items = n
                            }
                        }), (function(e, a) {
                            t.table_loading = !1
                        }))
            ...
            Pi = Ti,
            ji = Object(d["a"])(Pi, Ci, Vi, !1, null, null, null),
            Ii = ji.exports;
        u()(ji, {
            VBtn: m["a"],
            VCard: v["a"],
        ...
        var Di = function() {
            ...
            Ei = {
                methods: {
                    ...
                    submit_form: function() {
                        ...
                        if (this.selected_item && 0 != this.whats_app.length && 0 != this.description.length) {
                            ...
                            tt.post(this, "/user/add_suggestion", i, !0, (function(e, a) {
                                t.dialog = !1, 200 == a.data.code ? e.result_dialog = !0 : (e.error_content = a.data.msg, e.error_dialog = !0)
                            }), (function(e, a) {
                                t.dialog = !1, e.error_content = a, e.error_dialog = !0
                            }))
                        }
                    }
                },
                ...
                created: function() {
                    ...
                    "recharge" == t && (this.selected_item = this.$t("my.type_recharge"))
                },
                data: function() {
                    return {
                        error_content: "",
            ...
            Yi = Ei,
            Li = a("b56d"),
            Ai = Object(d["a"])(Yi, Di, qi, !1, null, null, null),
            zi = Ai.exports;
        u()(Ai, {
            VBtn: m["a"],
            VCard: v["a"],
        ...
        var Bi = function() {
                ...
                return a("div", {
                    ...
                    on: {
                        click: t.open_link_func
                    }
                }, [t._v(t._s(t.$t("my.open_link")) + "\n        ")])], 1)], 1)], 1), a("v-dialog", {
                    attrs: {
                        persistent: "",
                        "max-width": "80%"
                    },
                    ...
                    on: {
                        click: function(e) {
                            t.result_dialog = !1, t.load_promotion_info()
                        }
                    }
            ...
            Wi = {
                methods: {
                    ...
                    apply: function() {
                        this.apply_bonus = "", this.apply_dialog = !0
                    },
                    apply_all: function() {
                    ...
                    confirm_apply: function() {
                        if (0 != this.apply_bonus.length && !isNaN(this.apply_bonus) && !(parseFloat(this.apply_bonus) <= 0)) {
                            ...
                            tt.post(this, "/user/add_profit_transfer", t, !0, (function(t, e) {
                                t.dialog = !1, t.apply_dialog = !1, 200 == e.data.code ? t.result_dialog = !0 : (t.error_content = e.data.msg, t.error_dialog = !0)
                            }), (function(t, e) {
                                t.dialog = !1, t.apply_dialog = !1, t.error_content = e, t.error_dialog = !0
                            }))
                        }
                    },
                    open_link_func: function() {
                        window.open(this.r_link)
                    },
                    load_promotion_info: function() {
                        var t = Date.parse(new Date);
                        tt.get(this, "/user/my_promotion_info?t=" + t, !0, (function(t, e) {
                            200 == e.data.code && (t.bonus = t.$t("main.currency_symbol") + " " + e.data.profit, t.profit_amount = e.data.profit, t.info = e.data.info, t.handle_info())
                        }))
                    },
                    handle_info: function() {
                        0 == this.tab ? (this.total_people = this.info.one_level_user_count, this.contribution = this.$t("main.currency_symbol") + " " + this.info.one_level_contribution) : (this.total_people = this.info.two_level_user_count, this.contribution = this.$t("main.currency_symbol") + " " + this.info.two_level_contribution)
                    }
                },
                watch: {
                    tab: function() {
                ...
                created: function() {
                    this.r_code = localStorage.getItem("coem.r_code"), this.r_link = this.$store.state.appUrl + "/promote/#/register?c=" + this.r_code, this.load_promotion_info()
                },
                data: function() {
                    return {
                        error_content: "",
            ...
            Oi = Wi,
            Fi = Object(d["a"])(Oi, Bi, Ri, !1, null, null, null),
            Ni = Fi.exports;
        u()(Fi, {
            VBtn: m["a"],
            VCard: v["a"],
        ...
        var Ui = function() {
                ...
                return a("div", {
                    ...
                    scopedSlots: t._u([{
                        ...
                        fn: function(e) {
                            ...
                            }, [a("v-list-tile-title", [a("span", [t._v(t._s(t.$t("win.period")) + ":" + t._s(e.item.relation_id))])]), a("v-list-tile-sub-title", {
                                staticStyle: {
                                    "font-size": "12px"
                                }
            ...
            Gi = {
                ...
                methods: {
                    ...
                    load_bonus_record: function(t) {
                        var e = this.pagination,
                            ...
                            i = e.rowsPerPage;
                        this.table_loading = !0;
                        var n = "/user/profit_transactions?p=" + a + "&p_size=" + i + "&level=" + t;
                        tt.get(this, n, !0, (function(t, e) {
                            if (t.table_loading = !1, 200 == e.data.code) {
                                var a = e.data.page;
                                t.total = a.count, t.queryset = e.data.queryset
                            }
                        }))
                    }
                },
                watch: {
                    ...
                    tab: {
                        handler: function() {
                            this.total = 0, this.queryset = [], this.pagination.page = 1, this.load_bonus_record(this.tab + 1)
                        }
                    }
                },
                data: function() {
            ...
            Hi = Gi,
            Ki = Object(d["a"])(Hi, Ui, Mi, !1, null, null, null),
            Ji = Ki.exports;
        u()(Ki, {
            VBtn: m["a"],
            VCard: v["a"],
        ...
        var Qi = function() {
                ...
                return a("div", {
                    ...
                    scopedSlots: t._u([{
                        ...
                        fn: function(e) {
                            ...
                            }, [a("v-list-tile-avatar", [a("v-icon", [t._v("account_box")])], 1), a("v-list-tile-content", [a("v-list-tile-title", [t._v(t._s(e.item.nick_name))]), 0 == t.tab ? a("v-list-tile-sub-title", [t._v("First recharge: " + t._s(e.item.first_recharge_price))]) : t._e()], 1), a("v-list-tile-action", [a("v-list-tile-sub-title", {
                                staticStyle: {
                                    "font-size": "12px"
                                }
                            }, [t._v(t._s(t._f("date_format")(e.item.create_time)))])], 1)], 1)], 1)]
                        }
                    }])
                })], 1)], 1)
            },
            ...
            Zi = {
                ...
                methods: {
                    ...
                    load_promotion_users: function(t) {
                        var e = this.pagination,
                            ...
                            i = e.rowsPerPage;
                        this.table_loading = !0;
                        var n = "/user/promotion_users?p=" + a + "&p_size=" + i + "&level=" + t;
                        tt.get(this, n, !0, (function(t, e) {
                            if (t.table_loading = !1, 200 == e.data.code) {
                                var a = e.data.page;
                                t.total = a.count, t.queryset = e.data.queryset
                ...
                watch: {
                    ...
                    tab: {
                        handler: function() {
                            this.total = 0, this.queryset = [], this.pagination.page = 1, this.load_promotion_users(this.tab + 1)
                        }
                    }
                },
                data: function() {
            ...
            tn = Zi,
            en = Object(d["a"])(tn, Qi, Xi, !1, null, null, null),
            an = en.exports;
        u()(en, {
            VBtn: m["a"],
            VCard: v["a"],
        ...
        var nn = function() {
                ...
                return a("div", {
                    ...
                    scopedSlots: t._u([{
                        ...
                        fn: function(e) {
                            ...
                            }, [t._v("hourglass_empty")]) : t._e(), "Completed" == e.item.status ? a("v-icon", {
                                staticClass: "green white--text"
                            ...
                            }, [t._v(t._s(t._f("date_format")(e.item.create_time)) + "\n              ")])], 1), a("v-list-tile-action", [a("v-list-tile-title", [t._v(t._s(e.item.price))])], 1)], 1)], 1)]
                        }
                    }])
                })], 1)], 1)
            },
            ...
            sn = {
                ...
                methods: {
                    ...
                    load_apply_record: function() {
                        var t = this.pagination,
                            ...
                            a = t.rowsPerPage;
                        this.table_loading = !0;
                        var i = "/user/profit_transfers?p=" + e + "&p_size=" + a;
                ...
                watch: {
                    ...
                    tab: {
                        handler: function() {
                            this.total = 0, this.queryset = [], this.pagination.page = 1, this.load_apply_record()
                        }
                    }
                },
                data: function() {
            ...
            rn = sn,
            ln = Object(d["a"])(rn, nn, on, !1, null, null, null),
            cn = ln.exports;
        u()(ln, {
            VBtn: m["a"],
            VCard: v["a"],
        ...
        var dn = function() {
                ...
                return a("div", {
                ...
                }, [a("v-icon", [t._v("arrow_back")])], 1), a("v-toolbar-title", [t._v(t._s(t.$t("my.recharge")))]), a("v-spacer")], 1), a("v-card", {
                    staticStyle: {
                ...
                }, [t._v("Order No: " + t._s(t.serial_number))])]), a("v-flex", {
                    staticStyle: {
                        "margin-bottom": "12px"
                    },
                    attrs: {
                ...
                }, [t._v("Money: " + t._s(t.price) + " Rs")])]), a("v-flex", {
                    staticStyle: {
                        "margin-bottom": "12px"
                    },
                    attrs: {
                    ...
                    on: {
                        "click:append": t.copy_upi_account
                    }
                })], 1), a("v-flex", {
                    staticStyle: {
                        "margin-bottom": "12px"
                ...
                }, [a("span", [t._v("Please copy UPI account, and open payment software (such as Paytm, GooglePay, PhonePe) transfer to it.")])]), a("v-flex", {
                    attrs: {
                        xs12: "",
                        sm6: ""
                    }
                    ...
                    attrs: {
                        id: "copy_btn",
                        "data-clipboard-target": "#upi_account"
                    }
                }), a("v-dialog", {
                    attrs: {
                        persistent: "",
                    ...
                    model: {
                        value: t.payment_dialog,
                        callback: function(e) {
                            t.payment_dialog = e
                        },
                        expression: "payment_dialog"
                    }
                }, [a("v-card", [a("v-card-title", {
                    staticClass: "headline"
                }, [t._v("Open")]), a("v-card-text", {
                    staticStyle: {
                        "padding-top": "0"
                    }
                }, [a("v-container", {
                    ...
                    model: {
                        value: t.copy_result_dialog,
                        callback: function(e) {
                            t.copy_result_dialog = e
                        },
                        expression: "copy_result_dialog"
                    }
                }, [a("v-card", [a("v-card-title", {
                    staticClass: "headline"
                }, [t._v(t._s(t.$t("main.completed")))]), a("v-card-text", [t._v(t._s(t.upi_account) + " is copied")]), a("v-card-actions", [a("v-spacer"), a("v-btn", {
                    attrs: {
                        color: "primary darken-1",
                        flat: ""
                    },
                    on: {
                        click: function(e) {
                            t.copy_result_dialog = !1, t.go_transfer()
                        }
                    }
                }, [t._v("Go Transfer")])], 1)], 1)], 1)], 1)], 1)
            },
            _n = [],
            un = a("b311"),
            pn = a.n(un),
            mn = {
                methods: {
                    ...
                    copy_upi_account: function() {
                        console.log("copy_upi_account");
                        var t = document.getElementById("copy_btn");
                        t.click()
                    },
                    go_transfer: function() {
                        this.payment_dialog = !0
                    },
                    open_paytm: function() {
                        this.payment_dialog = !1, location.href = "http://m.p-y.tm"
                    },
                    open_googlepay: function() {
                        this.payment_dialog = !1, location.href = "tez://"
                    },
                    open_phonepe: function() {
                        this.payment_dialog = !1, location.href = "phonepe://"
                    }
                },
                data: function() {
                    return {
                        copy_result_dialog: !1,
                        payment_dialog: !1,
                        serial_number: "",
                        price: "",
                        upi_account: ""
                ...
                created: function() {
                    this.serial_number = this.$route.query.serial_number, this.price = this.$route.query.price, this.upi_account = this.$route.query.upi_account
                },
                mounted: function() {
                    var t = this,
                        e = new pn.a(".copy_btn");
                    e.on("success", (function(e) {
                        console.log("copy success"), e.clearSelection(), t.copy_result_dialog = !0
                    })), e.on("error", (function(t) {
                        console.log("copy error: " + t)
                    }))
                }
            },
            vn = mn,
            hn = Object(d["a"])(vn, dn, _n, !1, null, null, null),
            gn = hn.exports;
        u()(hn, {
            VBtn: m["a"],
            VCard: v["a"],
        ...
        var fn = function() {
            ...
            bn = {
                created: function() {
                    if (this.$store.state.is_show_win_tab) {
                        this.$store.state.show_bottom_menu = !1;
                        var t = this.$route.query.s;
                        t && t.length > 0 && (this.saas_id = t), this.load_next_period_info();
                        var e = (new Date).getTime();
                        this.$store.state.parity_count_down_tag = e, this.start_count_down(e), document.addEventListener("visibilitychange", this.auto_reload_listener)
                    } else history.go(-1)
                },
                destroyed: function() {
                ...
                methods: {
                    auto_reload_listener: function() {
                        "hidden" === document.visibilityState && console.log("page hidden"), "visible" === document.visibilityState && (console.log("page visible"), this.load_next_period_info())
                    },
                    ...
                    load_rd_table: function() {
                        ...
                        for (var i in this.periods) {
                            ...
                            this.multi_desserts.length <= e && this.multi_desserts.push({}), this.multi_desserts[e][a] = s, e += 1, e >= t && (e = 0, a += 1)
                        }
                    ...
                    load_next_period_info: function() {
                        var t = this,
                            ...
                            a = Date.parse(new Date);
                        e += "&t=" + a, e += "&saas_id=" + this.saas_id, tt.get(this, e, !1, (function(e, a) {
                            if (200 == a.data.code) {
                                e.next_period = a.data.next_period;
                                var i = a.data.periods;
                                if (e.periods = i, null == i || 0 == i.length) return;
                                e.load_rd_table();
                                var n = i[i.length - 1];
                                n.is_violet ? (n.price_class = "violet_title", n.is_red ? n.class = "item-violet-red-big" : n.class = "item-violet-green-big") : n.is_red ? (n.price_class = "red_title", n.class = "item-red-big") : (n.price_class = "green_title", n.class = "item-green-big"), e.pre_period = n, e.desserts = [], e.number_count_dict = {
                                    0: 0,
                                    1: 0,
                                    2: 0,
                                    3: 0,
                                ...
                                var o, s = 0,
                                    ...
                                    _ = 1,
                                    u = i[0];
                                for (var p in o = u.is_green ? "green" : "red", i) {
                                    var m = i[p];
                                    e.number_count_dict[m.last_num] = e.number_count_dict[m.last_num] + 1, "green" == o && m.is_green || "red" == o && m.is_red || (o = m.is_green ? "green" : "red", d = 0, _ += 1);
                                    var v = "";
                                    v = m.is_violet ? m.is_green ? "item-violet-green" : "item-violet-red" : m.is_green ? "item-green" : "item-red", m.is_violet && (l += 1), m.is_green && (r += 1), m.is_red && (s += 1);
                                    var h = {
                                    ...
                                    e.desserts.length <= d && e.desserts.push({}), t.desserts[d][_] = h, d += 1, c < d && (c = d)
                                }
                                e.table_td_length = _, e.red_count = s, e.green_count = r, e.violet_count = l, e.color_max = s > r ? 2 * s : 2 * r
                            }
                        }))
                    },
                    continue_click: function() {
                        this.load_next_period_info(), this.count_down_num_show = !0, this.continue_button_show = !1, this.continue_button_disabled = !0
                    },
                    start_count_down: function(t) {
            ...
            xn = bn,
            wn = (a("195f"), Object(d["a"])(xn, fn, yn, !1, null, null, null)),
            kn = wn.exports;
        u()(wn, {
            VBtn: m["a"],
            VDataTable: jt["a"],
        ...
        var Sn = function() {
            ...
            Vn = Cn,
            Tn = (a("92a6"), Object(d["a"])(Vn, Sn, $n, !1, null, null, null)),
            Pn = Tn.exports;
        u()(Tn, {
            VBtn: m["a"],
            VDataTable: jt["a"],
        ...
        var jn = function() {
            ...
            qn = Dn,
            En = (a("50d7"), Object(d["a"])(qn, jn, In, !1, null, null, null)),
            Yn = En.exports;
        u()(En, {
            VBtn: m["a"],
            VDataTable: jt["a"],
        ...
        var Ln = function() {
            ...
            Bn = zn,
            Rn = (a("a25b"), Object(d["a"])(Bn, Ln, An, !1, null, null, null)),
            Wn = Rn.exports;
        u()(Rn, {
            VBtn: m["a"],
            VDataTable: jt["a"],
        ...
        var On = [{
            ...
            Gn = {
                install: function(t, e) {
                    t.filter("datefmt", (function(t, e) {
                        return Mn()(t).format(e)
                    })), t.filter("time_ago", (function(t, e) {
                        return Mn.a.locale("zh-cn"), Mn()(t, e).fromNow()
            ...
            Xn = a("487a"),
            Zn = a.n(Xn),
            to = (a("bf40"), a("5363"), a("a4b1"), a("a925")),
            eo = a("2b27"),
            ao = a.n(eo);
        i["default"].use(ao.a), i["default"].use(P.a, {
            iconfont: "mdi",
            theme: {
                primary: Qn.a.green.darken1,
                secondary: Qn.a.grey.darken1,
                accent: Qn.a.shades.black,
                error: Qn.a.red.accent3,
                select_green: Qn.a.green.accent3,
                select_red: Qn.a.red.accent3,
                select_violet: Qn.a.deepPurple.accent3,
                select_num: Qn.a.lightBlue.accent3
            }
        }), i["default"].use(C["a"]), i["default"].use(j["a"]), i["default"].use(Gn), i["default"].use(Zn.a), i["default"].config.productionTip = !1, i["default"].prototype.$ajax = Kn.a, i["default"].use(to["a"]);
        var io = new to["a"]({
            locale: Rt.state.locale,
            messages: { in: a("fd34"),
                vi: a("33ba")
            }
        });
        ...
        }).$mount("#app"), Nn.afterEach((function(t, e, a) {
            window.scrollTo(0, 0)
        }))
    },
    6273: function(t, e, a) {},
    ...
    acf3: function(t, e, a) {
        t.exports = a.p + "img/colorwiz_event.58a735b9.jpg"
    },
    af70: function(t, e, a) {},
    df7e: function(t, e, a) {
        "use strict";
    ...
    fd34: function(t, e) {
        t.exports = {
            shop: {
                ...
                pay_now: "Pay Now",
                open_with_an_app: "Get NEW APP now"
            },
            win: {
            ...
            my: {
                ...
                nick_name: "Nick Name",
                balance: "Balance",
                enter_select_recharge_amount: "Please select recharge amount",
                payment: "Payment",
                payout: "Payout",
                ...
                enter_pwd: "Enter your login password",
                enter_payment_pwd: "Enter your login password",
                ...
                receive_event_gift: "Receive Event Gift",
                bank_name: "Bank Name",
